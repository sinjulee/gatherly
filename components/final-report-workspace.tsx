...
import { CloudUpload, FileText, Pencil, RefreshCw, Sparkles, TriangleAlert } from "lucide-react";
...
export function FinalReportWorkspace({ projects }: { projects: Project[] }) {
  ...
  async function createReport(parentReportId?:string){
    ...
    try{
      ...
      setNotice(isRevision?`v${d.report.version} 수정본 생성을 시작했습니다.`:"Mac mini Codex에 최종 보고서 생성을 요청했습니다.");
