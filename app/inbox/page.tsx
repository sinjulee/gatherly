...
export default async function Inbox() {
  ...
  return <div className="inbox-page mx-auto w-full min-w-0 max-w-[1320px] overflow-x-hidden px-5 py-7 md:px-10 md:py-10"><PageHeader eyebrow="INBOX · SAFE CAPTURE" title="자료수집함" description="사진·영상·음성·텍스트를 파일별로 저장 확인하며 관리합니다." /><InboxWorkspace projects={projects} /></div>;
}
